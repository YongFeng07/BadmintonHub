...
public class QrCodeHelperTests
{
    ...
    {
        var dataUri = QrCodeHelper.GenerateDataUri("BH-2026-000001");
    ...
    {
        var first = QrCodeHelper.GenerateDataUri("BH-2026-000001");
        var second = QrCodeHelper.GenerateDataUri("BH-2026-000002");
