        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperatingDays = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Rules = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourtNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourtAvailabilities_CourtId_Date_StartTime",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courts_CourtNumber_FacilityId",
                table: "Courts",
                columns: new[] { "CourtNumber", "FacilityId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_CourtId_ReservationDate_StartTime_EndTime",
                table: "Reservations",
                columns: new[] { "CourtId", "ReservationDate", "StartTime", "EndTime" });

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_ReservationReference",
                table: "Reservations",
